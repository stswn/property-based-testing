...
var numberGen = fc.integer();
var randomGenerator = prand.mersenne(42);
var numberSample = numberGen.generate(new fc.Random(randomGenerator));
console.log("Generated number: " + numberSample.value);
var idx = 1;
try {
    for (var _b = __values(numberSample.shrink()), _c = _b.next(); !_c.done; _c = _b.next()) {
